#!/usr/bin/env python3
"""OTel Demo Lab contract definitions - stable data types and constants.

This module contains the stable contract definitions for the OTel Demo Lab:
- Dataclasses for lab configuration and results
- Constants for lab modes and scenarios
- TypedDict definitions for phase results

These definitions are intentionally separated from CLI/orchestration logic
to keep the main script LLM-friendly and allow focused testing.
"""
