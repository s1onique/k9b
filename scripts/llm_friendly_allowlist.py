...
ALLOWLIST: list[tuple[str, str]] = [
    ...
    ("src/k8s_diag_agent/ui/server.py", "[EXTRACTION] Server routes - batch execution, execution side effects, and context loading extracted; response/API helpers remain"),
