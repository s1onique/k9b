...
ALLOWLIST: list[tuple[str, str]] = [
    ...
    ("src/k8s_diag_agent/ui/server_reads.py", "[EXTRACTION] Server reads - /api/runs, debug routes, promotions, external-analysis counting extracted; /api/notifications and /api/run handlers remain"),
