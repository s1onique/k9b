...
ALLOWLIST: list[tuple[str, str]] = [
    ...
    # Extracted models to next_check_planner_models.py (191 lines)
    ("src/k8s_diag_agent/external_analysis/next_check_planner.py", "[EXTRACTION] Next check planner - models extracted; 1029 lines remaining"),
