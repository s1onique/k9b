...
ALLOWLIST: list[tuple[str, str]] = [
    ...
    ("src/k8s_diag_agent/ui/server_read_support.py", "[EXTRACTION] Read support - cluster/drilldown helpers in server_read_clusters.py; next-check helpers in server_read_next_checks.py; llm-stats remain"),
