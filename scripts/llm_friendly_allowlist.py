...
ALLOWLIST: list[tuple[str, str]] = [
    ...
    ("src/k8s_diag_agent/ui/api_incident_report.py", "[EXTRACTION] Incident report - worklist builders extracted to api_incident_report_worklist.py (635 lines); worklist helpers remain in api_incident_report_worklist_helpers.py (209 lines); incident/report builders remain (~680 lines)"),
