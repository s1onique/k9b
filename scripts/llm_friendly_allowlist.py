...
ALLOWLIST: list[tuple[str, str]] = [
    ...
    ("src/k8s_diag_agent/health/loop_scheduler.py", "[EXTRACTION] Loop scheduler - models, locking, diagnostics, config, and cycle helpers extracted; run() delegates to cycle helpers; lock methods inline"),
