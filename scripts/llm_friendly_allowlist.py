...
ALLOWLIST: list[tuple[str, str]] = [
    ...
    ("src/k8s_diag_agent/external_analysis/alertmanager_discovery.py", "[EXTRACTION] Alertmanager discovery - models extracted (1070 lines); strategies/verification remain"),
