...
ALLOWLIST: list[tuple[str, str]] = [
    ...
    ("src/k8s_diag_agent/ui/server.py", "[EXTRACTION] Server routes - batch execution and execution side effects extracted; API reads/context/response helpers remain"),
