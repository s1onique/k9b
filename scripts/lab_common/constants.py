...
FAILURE_PROVIDER_HEALTH_OUTPUT_CONTAMINATED = "provider_health_output_contaminated"
FAILURE_PROVIDER_HEALTH_EMPTY_BODY = "provider_health_empty_body"

# Retry configuration for P0b provider preflight
...
# Retry configuration for P4c backend diagnosis (incident fetch)
# Exponential backoff: 0.25, 0.5, 1.0, 2.0, 4.0, 8.0 seconds
P4C_BACKEND_RETRY_DEADLINE_SECONDS = 60
P4C_BACKEND_RETRY_INITIAL_SLEEP_SECONDS = 0.25
P4C_BACKEND_RETRY_MAX_SLEEP_SECONDS = 8
P4C_BACKEND_RETRY_CONNECT_TIMEOUT = 2
P4C_BACKEND_RETRY_MAX_TIME = 5
