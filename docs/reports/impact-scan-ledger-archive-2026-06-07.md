# Impact Scan Effectiveness Ledger Archive (pre-2026-07-15)

**Purpose:** Historical entries from ACTs before 2026-07-15, split from the canonical ledger to keep the active ledger under the llm-friendly 500-line threshold. The discipline documentation in the canonical ledger still applies.
