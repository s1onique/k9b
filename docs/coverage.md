...
This is the canonical full coverage report generator. It runs both backend and frontend coverage and produces machine-readable artifacts for CI.
...
For targeted coverage of individual components:
