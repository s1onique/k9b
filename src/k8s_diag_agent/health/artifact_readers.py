...
DrilldownArtifact, and NotificationArtifact files from disk, replacing scattered
ad-hoc json.loads() + from_dict() patterns.

Supported artifact families: ClusterSnapshot, HealthProposal, DrilldownArtifact,
NotificationArtifact. Do not extend without validation against this pattern.
