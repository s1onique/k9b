"""Next-check execution history assembly for UI rendering.

This module extracts the public entry point and supporting helpers
for building execution history entries from artifacts.
"""
...
def _classify_execution_failure(artifact: ExternalAnalysisArtifact) -> FailureFollowUp | None:
    ...
    # Import failure constants locally to avoid circular deps
