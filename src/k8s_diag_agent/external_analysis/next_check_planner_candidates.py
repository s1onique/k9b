...
from .next_check_planner_candidate_execution import (
...
def build_candidates_from_enrichment(
    ...
    for candidate_text in checks:
        ...
        if execution_context:
            related_digest = find_execution_result_for_candidate(
                candidate_text, execution_context
            )
            if related_digest:
                execution_provenance = build_execution_provenance(related_digest)
