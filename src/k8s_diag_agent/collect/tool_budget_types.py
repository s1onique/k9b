"""Tool budget types and core contracts.

This module contains the foundational types for tool budget contracts:
- Schema version
- Enums (ToolApprovalClass, ToolRedactionPolicy)
- Core dataclasses (ToolBudget, ToolBudgetValidationError, ToolBudgetEnforcementResult)
