"""Next-check execution handler for the UI server.

This module contains the execution handler for next-check workflows.

Architecture: This module imports from server_next_checks for the handler type
(avoiding circular imports via TYPE_CHECKING). The execute_manual_next_check
function is imported at module level to enable test mocking compatibility
(path: k8s_diag_agent.ui.server_next_checks.execute_manual_next_check).
"""
