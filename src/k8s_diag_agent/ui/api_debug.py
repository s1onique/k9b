...
The main production function is `build_execution_summary_diagnostics`.
Supporting helper functions have been extracted to `api_debug_helpers.py`.
"""
...
from .api_debug_helpers import (
    _is_debug_enabled,
    build_execution_state_bundle,
    get_recent_runs_debug_data,
    get_runs_debug_block,
    get_worklist_payload,
    is_debug_diagnostics_enabled,
)

__all__ = [
    "build_execution_summary_diagnostics",
    "get_recent_runs_debug_data",
    "get_runs_debug_block",
    "get_worklist_payload",
    "build_execution_state_bundle",
    "is_debug_diagnostics_enabled",
    "_is_debug_enabled",  # for tests
]
    ...
    *,
    ...
    if plan_data:
        ...
        if "candidates" in plan_data and isinstance(plan_data["candidates"], list):
            candidates_data = plan_data["candidates"]
            ...
            if "candidates" in payload and isinstance(payload["candidates"], list):
                candidates_data = payload["candidates"]
