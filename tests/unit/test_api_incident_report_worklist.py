"""Unit tests for operator worklist payload.

Tests worklist item construction and operator worklist payload building.
"""
...
from k8s_diag_agent.ui.api_incident_report import _build_incident_report_payload, _build_operator_worklist_payload
