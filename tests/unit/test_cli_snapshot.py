...
class CliSnapshotTest(unittest.TestCase):
    def test_snapshot_writes_json(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("k8s_diag_agent.cli_snapshot_handlers.list_kube_contexts", return_value=["demo"]), patch(
                "k8s_diag_agent.cli_snapshot_handlers.collect_cluster_snapshot",
    ...
    def test_batch_snapshot_collects_targets(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("k8s_diag_agent.cli_snapshot_handlers.list_kube_contexts", return_value=["alpha", "beta"]), patch(
                "k8s_diag_agent.cli_snapshot_handlers.collect_cluster_snapshot",
...
class CliConfigFallbackTest(unittest.TestCase):
    ...
    def test_run_feedback_allows_explicit_example_config(self) -> None:
        # Patch where run_feedback_loop is imported and used in cli_handlers
