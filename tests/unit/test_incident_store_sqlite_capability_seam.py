"""Tests for SQLite write context capability seam.

These tests verify that:
1. SQLiteWriteContext properly encapsulates write authority
2. Closed contexts reject use with clear errors
3. Lifecycle/state helpers use the capability correctly
4. Public store API remains stable
5. Cross-thread promotion still works
"""
