...
class TestTransitionRejectionReasonExtraction:
    """Tests for AST extraction of TransitionRejectionReason alias."""
...
''')
        ...
        try:
            reasons = verifier.extract_transition_rejection_reasons(temp_path)
...
''')
    ...
    def test_extracts_from_actual_domain_module(self) -> None:
        ...
        if domain_module.exists():
            reasons = verifier.extract_transition_rejection_reasons(str(domain_module))
...
''')
        ...
        try:
            errors = verifier.check_rejection_reason_type_alias(temp_path)
...
''')
    ...
    def test_passes_for_actual_domain_module(self) -> None:
        ...
        if domain_module.exists():
            errors = verifier.check_rejection_reason_type_alias(str(domain_module))
