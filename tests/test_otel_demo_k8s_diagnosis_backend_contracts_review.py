"""Unit tests for backend contracts - Review-related tests.

Tests automatic diagnosis review payload and incident fetch result tests.
"""
...
class TestIncidentFetchFailureConstants:
    ...
    def test_constants_follow_naming_convention(self) -> None:
        ...
        for const in [
            ...
            assert const.startswith("backend_incident_fetch_"), (
                f"Constant {const} should start with 'backend_incident_fetch_'"
            )
