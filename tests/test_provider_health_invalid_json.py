...
class TestLeadingWhitespaceHandling:
    ...
    These tests verify that leading whitespace is properly handled for non-contaminated responses:
    - Leading whitespace + clean JSON proceeds to semantic evaluation
    - Leading whitespace + concatenated JSON is invalid_json

    Contamination scenarios with leading whitespace are in test_provider_health_output_contamination.py.
    """
